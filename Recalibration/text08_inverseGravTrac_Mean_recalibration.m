    ...
    if umix.is202(i) %if ET2535
        ...
        if  strcmp(umix.gravName{i},'ET')
            for jPb = 1:n.blocksi %for the ET+2535 Pb analysis
                ...
                %Gn for r202205t
                uGn(count.ratio+3,1) = (masses.Pb202/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb);
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+3),2) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*mprior(st.rUgt+i), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,2)*...
                ...
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+3),count.beadVarRangePb+i) = [-((mprior(st.bePb+count.blocksPb)*(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*mprior(2)*mprior(st.rUgt+i)))/ ...
                ...
                %Gn for beta
                uGn(count.ratio:(count.ratio+3),st.bePb+count.blocksPb) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*mprior(2)*mprior(st.rUgt+i))* ...
        ...
        elseif  strcmp(umix.gravName{i},'RP')
            ...
            for jPb = 1:n.blocksi %for the RP+2535 Pb analysis
                ...
                uGn(count.ratio+3,1) = (masses.Pb202/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb);
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+3),2) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*mprior(st.rUgt+i), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,5)*...
                ...
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+3),count.beadVarRangePb+i) = [-((mprior(st.bePb+count.blocksPb)*(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*mprior(2)*mprior(st.rUgt+i)))/ ...
                    ...
                    -((mprior(st.bePb+count.blocksPb)*(masses.Pb202/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*mprior(1))/mprior(st.g205+i)), 0, 0, 0, 0, 0];
                %Gn for beta
                uGn(count.ratio:(count.ratio+3),st.bePb+count.blocksPb) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*mprior(2)*mprior(st.rUgt+i))* ...
                    log(masses.Pb208/(mprior(st.g205+i)*masses.Pb205)), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,3) + mprior(st.rPbt+i)*mprior(st.r76b+i) +...
        ...
        elseif strcmp(umix.gravName{i},'JMM') %for JMM
            ...
            for jPb = 1:n.blocksi %for the JMM+2535 Pb analysis
                ...
                uGn(count.ratio+3,1) = (masses.Pb202/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb);
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+3),2) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*mprior(st.rUgt+i), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,8)*...
                ...
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+3),count.beadVarRangePb+i) = [-((mprior(st.bePb+count.blocksPb)*(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*mprior(2)*mprior(st.rUgt+i)))/ ...
                    ...
                    -((mprior(st.bePb+count.blocksPb)*(masses.Pb202/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*mprior(1))/mprior(st.g205+i)), 0, 0, 0, 0, 0];
                %Gn for beta
                uGn(count.ratio:(count.ratio+3),st.bePb+count.blocksPb) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*mprior(2)*mprior(st.rUgt+i))* ...
                    log(masses.Pb208/(mprior(st.g205+i)*masses.Pb205)), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,3) + mprior(st.rPbt+i)*mprior(st.r76b+i) +...
        ...
        if  strcmp(umix.gravName{i},'ET')
            ...
            for jPb = 1:n.blocksi %for the ET+535 Pb analysis
                ...
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+2),2) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*mprior(st.rUgt+i), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,2)*...
                ...
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+2),count.beadVarRangePb+i) = [-((mprior(st.bePb+count.blocksPb)*(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*mprior(2)*mprior(st.rUgt+i)))/ ...
                    mprior(st.g205+i)), 0, 0, (masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*mprior(st.rPbt+i), (masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*...
                    mprior(2), (masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*mprior(st.r86b+i);
                    ...
                    mprior(st.g205+i)), 0, 0, 0, (masses.Pb206/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*mprior(2), (masses.Pb206/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)];
                %Gn for beta
                uGn(count.ratio:(count.ratio+2),st.bePb+count.blocksPb) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*mprior(2)*mprior(st.rUgt+i))* ...
        ...
        elseif strcmp(umix.gravName{i},'RP')
            ...
            for jPb = 1:n.blocksi %for the RP+535 Pb analysis
                ...
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+2),2) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*mprior(st.rUgt+i), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,5)*...
                ...
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+2),count.beadVarRangePb+i) = [-((mprior(st.bePb+count.blocksPb)*(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*mprior(2)*mprior(st.rUgt+i)))/ ...
                    mprior(st.g205+i)), 0, 0, (masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*mprior(st.rPbt+i), (masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*...
                    mprior(2), (masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*mprior(st.r86b+i);
                    -((mprior(st.bePb+count.blocksPb)*((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,3) + mprior(st.rPbt+i)*mprior(st.r76b+i) + ...
                    MC.r206238g.RP(M)*MC.ics.gravPb(M,5)*mprior(2)*mprior(st.rUgt+i)))/mprior(st.g205+i)),...
                    ...
                    mprior(st.g205+i)), 0, 0, 0, (masses.Pb206/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*mprior(2), (masses.Pb206/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)];
                %Gn for beta
                uGn(count.ratio:(count.ratio+2),st.bePb+count.blocksPb) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*mprior(2)*mprior(st.rUgt+i))* ...
                    log(masses.Pb208/(mprior(st.g205+i)*masses.Pb205)), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,3) + mprior(st.rPbt+i)*mprior(st.r76b+i) +...
                    MC.r206238g.RP(M)*MC.ics.gravPb(M,5)*mprior(2)*mprior(st.rUgt+i))*log((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205)), ...
        ...
        elseif  strcmp(umix.gravName{i},'JMM') %for JMM
            ...
            for jPb = 1:n.blocksi %for the JMM+535 Pb analysis
                ...
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+2),2) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*mprior(st.rUgt+i), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,8)*...
                ...
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+2),count.beadVarRangePb+i) = [-((mprior(st.bePb+count.blocksPb)*(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*mprior(2)*mprior(st.rUgt+i)))/ ...
                    mprior(st.g205+i)), 0, 0, (masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*mprior(st.rPbt+i), (masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*...
                    mprior(2), (masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*mprior(st.r86b+i);
                    -((mprior(st.bePb+count.blocksPb)*((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,3) + mprior(st.rPbt+i)*mprior(st.r76b+i) + ...
                    MC.r206238g.JMM(M)*MC.ics.gravPb(M,8)*mprior(2)*mprior(st.rUgt+i)))/mprior(st.g205+i)),...
                    ...
                    mprior(st.g205+i)), 0, 0, 0, (masses.Pb206/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*mprior(2), (masses.Pb206/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)];
                %Gn for beta
                uGn(count.ratio:(count.ratio+2),st.bePb+count.blocksPb) = [(masses.Pb208/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + mprior(st.rPbt+i)*mprior(st.r86b+i) + MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*mprior(2)*mprior(st.rUgt+i))* ...
                    log(masses.Pb208/(mprior(st.g205+i)*masses.Pb205)), ((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205))^mprior(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,3) + mprior(st.rPbt+i)*mprior(st.r76b+i) +...
                    MC.r206238g.JMM(M)*MC.ics.gravPb(M,8)*mprior(2)*mprior(st.rUgt+i))*log((mprior(st.g207+i)*masses.Pb207)/(mprior(st.g205+i)*masses.Pb205)), ...
...
%% Next up is U
    ...
    if  or(strcmp(umix.gravName{i},'ET'), strcmp(umix.gravName{i},'RP'))  %data reduction is the same for ET and RP: same grav solution, same tracer IC
        ...
        for jU = 1:n.blocksi %for ET + (2)535
            ...
            %Gn for beadVars
            uGn(count.ratio:(count.ratio+1),count.beadVarRangeU+i) = [((masses.U238/masses.U235)^mprior(st.betU+count.blocksU)*misc.r85b*MC.ics.gtU(M,2)*(misc.r85b*(MC.ics.gtU(M,2) - MC.ics.gtU(M,4) - mprior(st.rUbt+i)) + MC.ics.gtU(M,2)*mprior(st.rUbt+i)))/ ...
            ...
            %Gn for beta
            uGn(count.ratio:(count.ratio+1),st.betU+count.blocksU) = [((masses.U238/masses.U235)^mprior(st.betU+count.blocksU)*misc.r85b*MC.ics.gtU(M,2)*(MC.ics.gtU(M,4) + mprior(st.rUbt+i) + mprior(st.rUgt+i))* ...
    ...
    elseif strcmp(umix.gravName{i},'JMM')
        ...
        for jU = 1:n.blocksi %for JMM + (2)535
            ...
            %Gn for beadVars
            uGn(count.ratio:(count.ratio+1),count.beadVarRangeU+i) = [                ((masses.U238/masses.U235)^mprior(st.betU+count.blocksU)*misc.r85b*MC.ics.gtU(M,1)*(misc.r85b*(MC.ics.gtU(M,1) - MC.ics.gtU(M,4) - mprior(st.rUbt+i)) + MC.ics.gtU(M,1)*mprior(st.rUbt+i)))/ ...
            ...
            %Gn for beta
            uGn(count.ratio:(count.ratio+1),st.betU+count.blocksU) = [((masses.U238/masses.U235)^mprior(st.betU+count.blocksU)*misc.r85b*MC.ics.gtU(M,1)*(MC.ics.gtU(M,4) + mprior(st.rUbt+i) + mprior(st.rUgt+i))* ...
...
um = um - misc.nun*(eye(size(CM,1))+CM*uGn'/CD*uGn)\(CM*uGn'/CD*(fm-dobs)+um-mprior);
ummat(:,iters) = um;
    ...
    if umix.is202(i) %if ET2535
        ...
        if  strcmp(umix.gravName{i},'ET')
            for jPb = 1:n.blocksi %for the ET+2535 Pb analysis
                ...
                %Gn for r202205t
                uGn(count.ratio+3,1) = (masses.Pb202/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb);
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+3),2) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*um(st.rUgt+i), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,2)*...
                    um(st.rUgt+i), (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*um(st.rUgt+i), 0];
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+3),count.beadVarRangePb+i) = [-((um(st.bePb+count.blocksPb)*(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*um(2)*um(st.rUgt+i)))/ ...
                ...
                %Gn for beta
                uGn(count.ratio:(count.ratio+3),st.bePb+count.blocksPb) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*um(2)*um(st.rUgt+i))* ...
        ...
        elseif  strcmp(umix.gravName{i},'RP')
            ...
            for jPb = 1:n.blocksi %for the RP+2535 Pb analysis
                ...
                uGn(count.ratio+3,1) = (masses.Pb202/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb);
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+3),2) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*um(st.rUgt+i), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,5)*...
                    um(st.rUgt+i), (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*um(st.rUgt+i), 0];
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+3),count.beadVarRangePb+i) = [-((um(st.bePb+count.blocksPb)*(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*um(2)*um(st.rUgt+i)))/ ...
                    ...
                    -((um(st.bePb+count.blocksPb)*(masses.Pb202/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*um(1))/um(st.g205+i)), 0, 0, 0, 0, 0];
                %Gn for beta
                uGn(count.ratio:(count.ratio+3),st.bePb+count.blocksPb) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*um(2)*um(st.rUgt+i))* ...
                    log(masses.Pb208/(um(st.g205+i)*masses.Pb205)), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,3) + um(st.rPbt+i)*um(st.r76b+i) +...
        ...
        elseif strcmp(umix.gravName{i},'JMM') %for JMM
            ...
            for jPb = 1:n.blocksi %for the JMM+2535 Pb analysis
                ...
                uGn(count.ratio+3,1) = (masses.Pb202/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb);
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+3),2) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*um(st.rUgt+i), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,8)*...
                    um(st.rUgt+i), (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*um(st.rUgt+i), 0];
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+3),count.beadVarRangePb+i) = [-((um(st.bePb+count.blocksPb)*(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*um(2)*um(st.rUgt+i)))/ ...
                    ...
                    -((um(st.bePb+count.blocksPb)*(masses.Pb202/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*um(1))/um(st.g205+i)), 0, 0, 0, 0, 0];
                %Gn for beta
                uGn(count.ratio:(count.ratio+3),st.bePb+count.blocksPb) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*um(2)*um(st.rUgt+i))* ...
                    log(masses.Pb208/(um(st.g205+i)*masses.Pb205)), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET2535Pb(M,3) + um(st.rPbt+i)*um(st.r76b+i) +...
        ...
        if  strcmp(umix.gravName{i},'ET')
            ...
            for jPb = 1:n.blocksi %for the ET+535 Pb analysis
                ...
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+2),2) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*um(st.rUgt+i), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,2)*...
                    um(st.rUgt+i), (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*um(st.rUgt+i)];
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+2),count.beadVarRangePb+i) = [-((um(st.bePb+count.blocksPb)*(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*um(2)*um(st.rUgt+i)))/ ...
                    um(st.g205+i)), 0, 0, (masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*um(st.rPbt+i), (masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*...
                    um(2), (masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*um(st.r86b+i);
                    ...
                    um(st.g205+i)), 0, 0, 0, (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.ET(M)*um(2), (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)];
                %Gn for beta
                uGn(count.ratio:(count.ratio+2),st.bePb+count.blocksPb) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.ET(M)*MC.ics.gravPb(M,3)*um(2)*um(st.rUgt+i))* ...
        ...
        elseif strcmp(umix.gravName{i},'RP')
            ...
            for jPb = 1:n.blocksi %for the RP+535 Pb analysis
                ...
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+2),2) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*um(st.rUgt+i), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,5)*...
                    um(st.rUgt+i), (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*um(st.rUgt+i)];
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+2),count.beadVarRangePb+i) = [-((um(st.bePb+count.blocksPb)*(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*um(2)*um(st.rUgt+i)))/ ...
                    um(st.g205+i)), 0, 0, (masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*um(st.rPbt+i), (masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*...
                    um(2), (masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*um(st.r86b+i);
                    -((um(st.bePb+count.blocksPb)*((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,3) + um(st.rPbt+i)*um(st.r76b+i) + ...
                    MC.r206238g.RP(M)*MC.ics.gravPb(M,5)*um(2)*um(st.rUgt+i)))/um(st.g205+i)),...
                    ...
                    um(st.g205+i)), 0, 0, 0, (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.RP(M)*um(2), (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)];
                %Gn for beta
                uGn(count.ratio:(count.ratio+2),st.bePb+count.blocksPb) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.RP(M)*MC.ics.gravPb(M,6)*um(2)*um(st.rUgt+i))* ...
                    log(masses.Pb208/(um(st.g205+i)*masses.Pb205)), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,3) + um(st.rPbt+i)*um(st.r76b+i) +...
                    MC.r206238g.RP(M)*MC.ics.gravPb(M,5)*um(2)*um(st.rUgt+i))*log((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205)), ...
        ...
        elseif  strcmp(umix.gravName{i},'JMM') %for JMM
            ...
            for jPb = 1:n.blocksi %for the JMM+535 Pb analysis
                ...
                %Gn for r235205t
                uGn(count.ratio:(count.ratio+2),2) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*um(st.rUgt+i), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,8)*...
                    um(st.rUgt+i), (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*um(st.rUgt+i)];
                %Gn for beadVars
                uGn(count.ratio:(count.ratio+2),count.beadVarRangePb+i) = [-((um(st.bePb+count.blocksPb)*(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*um(2)*um(st.rUgt+i)))/ ...
                    um(st.g205+i)), 0, 0, (masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*um(st.rPbt+i), (masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*...
                    um(2), (masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*um(st.r86b+i);
                    -((um(st.bePb+count.blocksPb)*((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,3) + um(st.rPbt+i)*um(st.r76b+i) + ...
                    MC.r206238g.JMM(M)*MC.ics.gravPb(M,8)*um(2)*um(st.rUgt+i)))/um(st.g205+i)),...
                    ...
                    um(st.g205+i)), 0, 0, 0, (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*MC.r206238g.JMM(M)*um(2), (masses.Pb206/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)];
                %Gn for beta
                uGn(count.ratio:(count.ratio+2),st.bePb+count.blocksPb) = [(masses.Pb208/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,4) + um(st.rPbt+i)*um(st.r86b+i) + MC.r206238g.JMM(M)*MC.ics.gravPb(M,9)*um(2)*um(st.rUgt+i))* ...
                    log(masses.Pb208/(um(st.g205+i)*masses.Pb205)), ((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205))^um(st.bePb+count.blocksPb)*(MC.ics.ET535Pb(M,3) + um(st.rPbt+i)*um(st.r76b+i) +...
                    MC.r206238g.JMM(M)*MC.ics.gravPb(M,8)*um(2)*um(st.rUgt+i))*log((um(st.g207+i)*masses.Pb207)/(um(st.g205+i)*masses.Pb205)), ...
...
%% Next up is U
    ...
    if  or(strcmp(umix.gravName{i},'ET'), strcmp(umix.gravName{i},'RP'))  %data reduction is the same for ET and RP: same grav solution, same tracer IC
        ...
        for jU = 1:n.blocksi %for ET + (2)535
            ...
            %Gn for beadVars
            uGn(count.ratio:(count.ratio+1),count.beadVarRangeU+i) = [((masses.U238/masses.U235)^um(st.betU+count.blocksU)*misc.r85b*MC.ics.gtU(M,2)*(misc.r85b*(MC.ics.gtU(M,2) - MC.ics.gtU(M,4) - um(st.rUbt+i)) + MC.ics.gtU(M,2)*um(st.rUbt+i)))/ ...
            ...
            %Gn for beta
            uGn(count.ratio:(count.ratio+1),st.betU+count.blocksU) = [((masses.U238/masses.U235)^um(st.betU+count.blocksU)*misc.r85b*MC.ics.gtU(M,2)*(MC.ics.gtU(M,4) + um(st.rUbt+i) + um(st.rUgt+i))* ...
    ...
    elseif strcmp(umix.gravName{i},'JMM')
        ...
        for jU = 1:n.blocksi %for JMM + (2)535
            ...
            %Gn for beadVars
            uGn(count.ratio:(count.ratio+1),count.beadVarRangeU+i) = [                ((masses.U238/masses.U235)^um(st.betU+count.blocksU)*misc.r85b*MC.ics.gtU(M,1)*(misc.r85b*(MC.ics.gtU(M,1) - MC.ics.gtU(M,4) - um(st.rUbt+i)) + MC.ics.gtU(M,1)*um(st.rUbt+i)))/ ...
            ...
            %Gn for beta
            uGn(count.ratio:(count.ratio+1),st.betU+count.blocksU) = [((masses.U238/masses.U235)^um(st.betU+count.blocksU)*misc.r85b*MC.ics.gtU(M,1)*(MC.ics.gtU(M,4) + um(st.rUbt+i) + um(st.rUgt+i))* ...
